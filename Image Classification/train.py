...
group.add_argument('--layer_num_approx', type=int, default=None, metavar='N',
                   help='number of epochs to train (default: 300)')
group.add_argument('--head_num_approx', type=int, default=None, metavar='N',
                   help='number of epochs to train (default: 300)')
group.add_argument('--layer0_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer0')
group.add_argument('--layer1_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer1')
group.add_argument('--layer2_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer2')
group.add_argument('--layer3_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer3')
group.add_argument('--layer4_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer4')
group.add_argument('--layer5_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer5')
group.add_argument('--layer6_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer6')
group.add_argument('--layer7_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer7')
group.add_argument('--layer8_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer8')
group.add_argument('--layer9_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer9')
group.add_argument('--layer10_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer10')
group.add_argument('--layer11_list', type=str, default=None, metavar='N',
                   help='heads_approximated in layer11')
group.add_argument('--layer_num_new', type=int, default=None, metavar='N',
                   help='heads_approximated in layer11')
group.add_argument('--head_num_new', type=int, default=None, metavar='N',
                   help='heads_approximated in layer11')
...
def train_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        def _forward():
            with amp_autocast():
                output, loss_local = model(input, head_list)
                loss = loss_fn(output, target) + 0.00001*loss_local
            if accum_steps > 1:
                loss /= accum_steps
            return loss
        ...
        if m.weight.requires_grad:
            ...
            for name, module in model.named_modules():
                ...
                if module is m:
                    ...
                    layer_name = name
                    break
            if "blocks.{}.attn.softmax_16.{}.".format(args.layer_num_new,args.head_num_new) in layer_name:
                print("In")
                print("Initiation")
                torch.manual_seed(42)
                init.xavier_uniform_(m.weight)
...
try:
    # head_list = dict()
    # head_list[args.layer_num_approx] = list([args.head_num_approx])
    ...
    # head_list[args.layer_num_approx][0] = args.head_num_approx
    print(head_list)
    if num_epochs != 0:
